...
public class Loops extends Object {
	...
	public static void main(String [] args) {
		...
		//********************************** Starts Here *********************************
		int index = 0;
		while( index < someBools.length/2 ) { // Only go half way (other half is swapped in process)
			temp = someBools[someBools.length - 1 - index]; // Last element minus 1 (0-based index) minus i
			someBools[someBools.length - 1 - index] = someBools[index];
			someBools[index] = temp;
		}
		//********************************** Ends Here ***********************************
