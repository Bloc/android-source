...
public class Logic extends Object {
	...
	public static void main(String [] args) {
		...
		if (true && true) { // Changed the "false" into a "true"
			buffer.append("r");
		} else {
			buffer.append("w");
		}
		...
		if ((-8 < 0) && !(15 == 15) && (lastOne == true)) { // Changed the 8 into a negative
			buffer.append("t");
		} else {
			buffer.append("g");
		}
